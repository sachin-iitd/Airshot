...
common_path = 'nsgp_{}{}_fold{}_{}_{}_{}{}'.format(['delhi','canada','canada','usa','kolkata'][canada], canada if canada in [1,2] else '', c_fold, mode_t + ('T' if Config.temporal_scaling else ''), mode_c, mode_p, '_st' if '_st' in Config.data_path else '')
